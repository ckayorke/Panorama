...
import com.bosch.glm100c.easy_connect.NeedInfoActivity;
...
public class ProjectAdapter2 extends ArrayAdapter<Project> {
    ...
    private static NeedInfoActivity main;
    private static ProjectAdapter2 adapter;
    private static DataService helper;
    public ProjectAdapter2(Context context, int resource, int textViewResourceId, List<Project> list, DataService _helper) {
        super(context, resource, textViewResourceId, list);
        projectList.clear();
        projectList= list;
        main = (NeedInfoActivity) context;
        adapter = this;
        helper = _helper;
    }
    @Override
